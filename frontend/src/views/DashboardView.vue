<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
    ...
    <!-- Life Agent Modal -->
    <div v-if="showLifeAgentModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" @click.self="showLifeAgentModal = false">
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-4xl h-[80vh] m-4 flex flex-col overflow-hidden">
        <div class="flex justify-between items-center p-6 border-b border-gray-200 flex-shrink-0">
          <h2 class="text-2xl font-bold text-gray-900">{{ $t('lifeAgent.title') }}</h2>
          <button @click="showLifeAgentModal = false" class="text-gray-500 hover:text-gray-700 transition-colors">
